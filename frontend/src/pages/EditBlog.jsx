...
const saveBlog = ()=>{
  ...
  axios.put(`http://localhost:5555/blogs`, data)
  .then(()=>{
      setLoading(false);
      navigate('/');
  }).catch((error)=>{
...
<div className="max-w-2xl mx-auto p-6">
  ...
  <form className="space-y-4">
    ...
    <div>
      <label htmlFor ="blogContent" className="block font-semibold mb-1">Edit your blog:</label>
    ...
    <div>
      ...
      focus:outline-none mr-4" onClick={saveBlog}>Save Blog</button>
      <Link to='/'>
